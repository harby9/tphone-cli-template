...
const preprocessor = require('@dcloudio/core/lib/vue-cli-plugin-uni/packages/webpack-preprocess-loader/preprocess')

const traverse = require('@dcloudio/core/lib/webpack-uni-mp-loader/lib/babel/scoped-component-traverse')

const {
  resolve,
  normalizeNodeModules
} = require('@dcloudio/core/lib/webpack-uni-mp-loader/lib/shared')

const {
  findBabelLoader,
  addDynamicImport
} = require('@dcloudio/core/lib/webpack-uni-mp-loader/lib/babel/util')
