...
const WebpackOptimizePlugin = require('@dcloudio/core/lib/vue-cli-plugin-uni-optimize/packages/webpack-optimize-plugin')

const {
  src,
  lib
} = require('@dcloudio/core/lib/uni-h5/path')
