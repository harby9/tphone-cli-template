...
const {
  hasModule
} = require('@dcloudio/core/lib/uni-cli-shared/lib/util')
...
moduleAlias.addAlias('@vue/component-compiler-utils', require.resolve(
  '@dcloudio/core/lib/vue-cli-plugin-uni/packages/@vue/component-compiler-utils'))
moduleAlias.addAlias('@vue/component-compiler-utils/package.json', require.resolve(
  '@dcloudio/core/lib/vue-cli-plugin-uni/packages/@vue/component-compiler-utils/package.json'))
