const {
  ...
  compileTemplate
} = require('@dcloudio/core/lib/uni-template-compiler/lib/auto-components')

const {
  isUnaryTag
} = require('@dcloudio/core/lib/uni-template-compiler/lib/util')
...
compiler.compile = function (source, options = {}) {
  ...
  options.modules.push(require('@dcloudio/core/lib/uni-template-compiler/lib/asset-url'))
  options.modules.push(require('@dcloudio/core/lib/uni-template-compiler/lib/bool-attr'))
