...
const validate = require('@dcloudio/core/lib/uni-migration/lib/validate')

const patchVant = require('@dcloudio/core/lib/uni-migration/lib/vant')

const migraters = {
  'mp-weixin': require('@dcloudio/core/lib/uni-migration/lib/mp-weixin')
}
