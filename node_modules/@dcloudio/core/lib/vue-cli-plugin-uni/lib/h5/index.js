...
const runtimePath = '@dcloudio/core/lib/uni-mp-weixin/dist/mp.js'
const wxsPath = '@dcloudio/core/lib/uni-mp-weixin/dist/wxs.js'
    ...
    return {
      resolve: {
        ...
        alias: {
          ...
          'uni-h5': require.resolve('@dcloudio/core/lib/uni-h5')
        }
      },
      module: {
        rules: [{
