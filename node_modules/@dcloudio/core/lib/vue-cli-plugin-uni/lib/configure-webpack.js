...
} = require('@dcloudio/core/lib/vue-cli-plugin-uni/lib/util')
...
module.exports = function configureWebpack (platformOptions, manifestPlatformOptions, vueOptions, api) {
  ...
  const {
    getPlatformVue
  } = require('@dcloudio/core/lib/uni-cli-shared/lib/platform')

  const {
    getCopyWebpackPluginOptions
  } = require('@dcloudio/core/lib/vue-cli-plugin-uni/lib/copy-webpack-options')
  ...
  const tsLoaderOptions = {
    ...
    compilerOptions: {
      ...
      typeRoots: [resolveModule('@dcloudio/core/lib/types'), resolveModule('@types')],
      types: [
        'uni-app',
        'webpack-env'
      ],
      paths: {
        ...
        'mpvue-page-factory': [
          resolveModule('@dcloudio/core/lib/vue-cli-plugin-uni/packages/mpvue-page-factory')
        ]
      }
    },
  ...
  return function (webpackConfig) {
    ...
    if (require('@dcloudio/core/lib/uni-cli-shared/lib/util').isInHBuilderX) {
    ...
    if (process.env.NODE_ENV === 'development') {
      const sourceMap = require('@dcloudio/core/lib/uni-cli-shared/lib/source-map')
    ...
    return merge({
      ...
      resolve: {
        alias: {
          ...
          '@dcloudio/core/lib/uni-stat': process.env.UNI_USING_VUE3 ? require.resolve(
            '@dcloudio/core/lib/vue-cli-plugin-uni/packages/uni-stat') : require
            .resolve('@dcloudio/core/lib/uni-stat'),
          'uni-stat-config': path.resolve(process.env.UNI_INPUT_DIR, 'pages.json') +
            '?' +
            JSON.stringify({
              type: 'stat'
            }),
          vuex: require.resolve('@dcloudio/core/lib/vue-cli-plugin-uni/packages/vuex3')
        },
        modules: [
      ...
      watchOptions: require('@dcloudio/core/lib/vue-cli-plugin-uni/lib/util').getWatchOptions()
