...
const {
  sassLoaderVersion
} = require('@dcloudio/core/lib/uni-cli-shared/lib/scss')
...
module.exports = function initOptions (options) {
  ...
  options.transpileDependencies.push('@dcloudio/core/lib/uni-i18n')
  options.transpileDependencies.push('@dcloudio/core/lib/uni-stat')
  options.transpileDependencies.push('@dcloudio/core/lib/vue-cli-plugin-uni/packages/uni-app')
  options.transpileDependencies.push('@dcloudio/core/lib/vue-cli-plugin-uni/packages/uni-cloud')
  options.transpileDependencies.push('@dcloudio/core/lib/vue-cli-plugin-uni/packages/uni-stat')

  if (process.env.UNI_PLATFORM !== 'mp-weixin') { // mp runtime
    options.transpileDependencies.push('@dcloudio/core/lib/uni-mp-weixin')
  }
