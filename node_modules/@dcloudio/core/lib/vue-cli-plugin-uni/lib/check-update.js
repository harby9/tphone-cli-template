...
module.exports = async function checkUpdate () {
  ...
  const plp = require('@dcloudio/core/lib/webpack-uni-pages-loader/package.json')
  ...
  try {
    ...
    update.isAlpha = ppj.devDependencies['@dcloudio/core/lib/vue-cli-plugin-uni'].includes('alpha')
