...
} = require('@dcloudio/core/lib/vue-cli-plugin-uni/lib/env')

const {
  assetsDir
} = require('@dcloudio/core/lib/vue-cli-plugin-uni/lib/copy-webpack-options')

require('@dcloudio/core/lib/vue-cli-plugin-uni/lib/check-update')()

const initBuildCommand = require('@dcloudio/core/lib/vue-cli-plugin-uni/commands/build')
const initServeCommand = require('@dcloudio/core/lib/vue-cli-plugin-uni/commands/serve')
...
module.exports = (api, options) => {
  ...
  if (process.env.UNI_PLATFORM === 'quickapp-native') {
    ...
    require('@dcloudio/core/lib/vue-cli-plugin-uni/lib/options')(options)
    const platformOptions = {
      webpackConfig: {},
      chainWebpack () {}
    }
    const manifestPlatformOptions = {}
    api.configureWebpack(require('@dcloudio/core/lib/vue-cli-plugin-uni/lib/configure-webpack')(platformOptions, manifestPlatformOptions, options, api))
    api.chainWebpack(require('@dcloudio/core/lib/vue-cli-plugin-uni/lib/chain-webpack')(platformOptions, options, api))

    const vueConfig = require('@dcloudio/core/lib/uni-quickapp-native/lib/vue.config.js')
